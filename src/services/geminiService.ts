...
import type { MenuItem, Sale, InventoryItem, Order, User, ParsedOrder, ParsedInventoryCommand, ShoppingList, ProfeLocoResponse, ShoppingListItem, ProfeLocoActionResponse, ProfeLocoAction } from '../types';
...
const getAiClient = () => {
  ...
  // Suppress harsh error, just warn once if needed or fail silently for functions
